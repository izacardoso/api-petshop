...
class Produto {
    constructor({id, titulo, preco, estoque, fornecedor, dataCriacao, dataAtualizaco, versao}){
        this.id = id
        this.titulo = titulo
        this.preco = preco
    ...
    async criar (){
        ...
        this.dataAtualizaco = resultado.dataAtualizaco
    ...
    async carregar(){
        ...
        this.dataAtualizaco = produto.dataAtualizaco
    ...
    atualizar(){
        ...
        if(Object.keys(dadosParaAtualizar).length === 0){
            throw new Error('Não foram fornecidos dados pra atualizar')
        }
